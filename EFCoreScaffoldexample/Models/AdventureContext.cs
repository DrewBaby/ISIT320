...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=.\\;Database=AdventureWorksDW;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DimAccount>(entity =>
            {
                ...
                entity.HasIndex(e => e.AccountCodeAlternateKey, "AK_DimAccount_AccountCodeAlternateKey")
                    .IsUnique();
            ...
            modelBuilder.Entity<DimCustomer>(entity =>
            {
                ...
                entity.HasIndex(e => e.GeographyKey, "IX_DimCustomer_GeographyKey");
            ...
            modelBuilder.Entity<DimEmployee>(entity =>
            {
                ...
                entity.HasIndex(e => e.ParentEmployeeKey, "IX_DimEmployee_ParentEmployeeKey");

                entity.HasIndex(e => e.SalesTerritoryKey, "IX_DimEmployee_SalesTerritoryKey");
            ...
            modelBuilder.Entity<DimProduct>(entity =>
            {
                ...
                entity.HasIndex(e => e.ProductSubcategoryKey, "IX_DimProduct_ProductSubcategoryKey");

                entity.Property(e => e.ArabicDescription)
                    .HasMaxLength(400)
                    .UseCollation("Arabic_CI_AS");

                entity.Property(e => e.ChineseDescription)
                    .HasMaxLength(400)
                    .UseCollation("Chinese_PRC_CI_AI");
                ...
                entity.Property(e => e.GermanDescription)
                    .HasMaxLength(400)
                    .UseCollation("Latin1_General_100_CI_AS");

                entity.Property(e => e.HebrewDescription)
                    .HasMaxLength(400)
                    .UseCollation("Hebrew_CI_AS");

                entity.Property(e => e.JapaneseDescription)
                    .HasMaxLength(400)
                ...
                entity.Property(e => e.ThaiDescription)
                    .HasMaxLength(400)
                    .UseCollation("Thai_CI_AS");

                entity.Property(e => e.TurkishDescription)
                    .HasMaxLength(400)
            ...
            modelBuilder.Entity<DimReseller>(entity =>
            {
                ...
                entity.HasIndex(e => e.GeographyKey, "IX_DimReseller_GeographyKey");
            ...
            modelBuilder.Entity<FactInternetSale>(entity =>
            {
                ...
                entity.HasIndex(e => e.ShipDateKey, "IX_FactIneternetSales_ShipDateKey");

                entity.HasIndex(e => e.CurrencyKey, "IX_FactInternetSales_CurrencyKey");

                entity.HasIndex(e => e.CustomerKey, "IX_FactInternetSales_CustomerKey");

                entity.HasIndex(e => e.DueDateKey, "IX_FactInternetSales_DueDateKey");

                entity.HasIndex(e => e.OrderDateKey, "IX_FactInternetSales_OrderDateKey");

                entity.HasIndex(e => e.ProductKey, "IX_FactInternetSales_ProductKey");

                entity.HasIndex(e => e.PromotionKey, "IX_FactInternetSales_PromotionKey");
            ...
            modelBuilder.Entity<FactResellerSale>(entity =>
            {
                ...
                entity.HasIndex(e => e.CurrencyKey, "IX_FactResellerSales_CurrencyKey");

                entity.HasIndex(e => e.DueDateKey, "IX_FactResellerSales_DueDateKey");

                entity.HasIndex(e => e.EmployeeKey, "IX_FactResellerSales_EmployeeKey");

                entity.HasIndex(e => e.OrderDateKey, "IX_FactResellerSales_OrderDateKey");

                entity.HasIndex(e => e.ProductKey, "IX_FactResellerSales_ProductKey");

                entity.HasIndex(e => e.PromotionKey, "IX_FactResellerSales_PromotionKey");

                entity.HasIndex(e => e.ResellerKey, "IX_FactResellerSales_ResellerKey");

                entity.HasIndex(e => e.ShipDateKey, "IX_FactResellerSales_ShipDateKey");
            ...
            modelBuilder.Entity<FactSalesQuotum>(entity =>
            {
                ...
                entity.HasIndex(e => e.DateKey, "IX_FactSalesQuota_DateKey");

                entity.HasIndex(e => e.EmployeeKey, "IX_FactSalesQuota_EmployeeKey");
            ...
            modelBuilder.Entity<FactSurveyResponse>(entity =>
            {
                ...
                entity.HasIndex(e => e.CustomerKey, "IX_FactSurveyResponse_CustomerKey");

                entity.HasIndex(e => e.DateKey, "IX_FactSurveyResponse_DateKey");

                entity.HasIndex(e => e.ProductSubcategoryKey, "IX_FactSurveyResponse_ProductSubcategoryKey");
            ...
            modelBuilder.Entity<ProspectiveBuyer>(entity =>
            {
                ...
                entity.HasIndex(e => e.ProspectAlternateKey, "IX_ProspectiveBuyer_ProspectAlternateKey");
